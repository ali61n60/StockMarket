...
#define PCF8833			9
#define S1D19122		10
#define SSD1963_480		11
#define SSD1963_800		12
#define S6D1121_8		13
#define S6D1121_16		14
#define ST7735			15
#define HX8353			16
#define S6D02A1			17
#define ILI9341			18
...
#define LPH9135			9	// PCF8833	(Serial)
#define ITDB25H			10	// S1D19122	(16bit)
#define ITDB43			11	// SSD1963	(16bit) 480x272
#define ITDB50			12	// SSD1963	(16bit) 800x480
#define ITDB24E_8		13	// S6D1121	(8bit)
#define ITDB24E_16	14	// S6D1121	(16bit)

#define QD_TFT180A	15	// 1.8 ST7735   (Serial)
#define QD_TFT180B	16	// 1.8 HX8353   (Serial)
#define QD_TFT180C	17	// 1.8 S6D02A1   (Serial)
#define QD_TM220		18	// 2.2 inch ILI9341(Serial)
...
class UTFT
{
	...
	protected:
		...
		regtype *P_RS, *P_WR, *P_CS, *P_RST, *P_SDA, *P_SCL,*P_LED;
		regsize B_RS, B_WR, B_CS, B_RST, B_SDA, B_SCL,B_LED;
		_current_font	cfont;
